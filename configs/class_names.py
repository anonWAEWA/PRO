LABEL_NAMES = {
    ...
    "camelyon": ["tissue without tumor", "tissue containing tumor"],
    "fmow": [
        "airport",
        "airport_hangar",
        "airport_terminal",
    ...
    "nonliving26": [
        ...
        "hat, chapeau or lid",
        "keyboard instrument",
        "mercantile establishment, retail store or outlet",
        "outbuilding",
        ...
        "skirt",
        "stringed instrument",
        "timepiece, timekeeper or horologe",
        "truck",
        "wind instrument",
        "squash",
    ],
    ...
    "fer2013": [
        # Not supporting multiple class names for now
        # ['angry'],
        # ['disgusted'],
        # ['fearful'],
        # ['happy', 'smiling'],
